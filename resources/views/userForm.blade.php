  ...
  @endfor --}}
    ...
    <div id="card">
      ...
      @endif --}}
            ...
            <form method="post" class="form" action={{ route('register_user') }} enctype="multipart/form-data">
                @csrf
                {{-- {{method_field('put')}} --}}
                ...
                <input id="user-confirm-password" class="form-content" type="password" name="confirm-password"
                    autocomplete="off" />
                <div class="form-border"></div>
                <span style="color:red;font-weight:200">
