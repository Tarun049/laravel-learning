...
<body>
  ...
  <div id="card">
    <div id="card-content">
      ...
      <form method="post" class="form" action="/request/form">
        @csrf
        {{-- {{method_field('put')}} --}}
        ...
        <input id="user-Name" class="form-content" type="Name" name="name" autocomplete="on"/>
        ...
        <input id="user-phone" class="form-content" type="number" name="phone" autocomplete="off"/>
        <div class="form-border"></div>
        <span style="color:red;font-weight:200">@error('phone'){{$message}}@enderror</span>

        <label for="user-password" style="padding-top:22px">&nbsp;Password
          </label>
        <input id="user-password" class="form-content" type="password" name="password" autocomplete="off"/>
        <div class="form-border"></div>
        <span style="color:red;font-weight:200">@error('password'){{$message}}@enderror</span>
        
        
        <label for="user-confirm-password" style="padding-top:22px">&nbsp;Confirm Password
        </label>
        <input id="user-confirm-password" class="form-content" type="password" name="confirm-password" autocomplete="off"/>
        <div class="form-border"></div>
        <span style="color:red;font-weight:200">@error('confirm-password'){{$message}}@enderror</span>
